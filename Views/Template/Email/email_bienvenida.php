...
<style>
    ...
    .credential-item strong { color: #0f172a; }
    ...
    .button {
        ...
        max-width: 260px;
        margin: 30px auto;
        background: #2563eb; /* Un azul más vibrante para el CTA */
...
<div class="wrapper">
    <div class="container">
        ...
        <div class="body">
            ...
            <p class="welcome-text">Hola <strong><?= $data['nombreUsuario']; ?></strong>, nos hace muy felices que te hayas unido a nosotros.</p>

            <p>Tu cuenta ha sido creada exitosamente. Ahora puedes acceder a nuestra tienda virtual y disfrutar de todos nuestros productos.</p>

            <div class="credentials-box">
                <div class="credential-item"><strong>Usuario:</strong> <?= $data['email']; ?></div>
                <div class="credential-item"><strong>Contraseña:</strong> <?= $data['password']; ?></div>
            </div>

            <p style="text-align: center;">Haz clic en el botón de abajo para explorar nuestro catálogo:</p>
            ...
            <p style="font-size: 14px;">
                Si tienes alguna duda, nuestro equipo de soporte está listo para ayudarte. <br>
        ...
        <div class="footer">
            ...
            <p class="social-notice">Este es un correo automático, por favor no respondas a este mensaje.</p>
        </div>
